...
\begin{tabular}{|m{0.2\linewidth}|m{0.755\linewidth}|}
\hline
Predicate functions or Lambdas & 
\begin{lstlisting}
auto is_odd = [](auto i) -> bool {return i % 2;};
auto divides = [](auto i, auto j) -> bool {return !(i % j);};
// the () can be omitted as long as there are no parameters!
\end{lstlisting}
\textcolor{OliveGreen}{Note, the [] are always necessary af of 2022, perhaps some day cpp standard :)}\\
\hline
