...
\hline
  Weak<T> & 
  Weak<T> is essentially a special count of references that will be ignored for dropping, meaning that if there are no strong rc counts but some weak rc remaining, then the value will be dropped either way!\newline
